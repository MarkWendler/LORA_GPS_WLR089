...
typedef struct __attribute__((__packed__)) _PdsWlHeader_t
{
    uint8_t magicNo;
    uint8_t version;
    uint8_t size;
...
{
    struct __attribute__((__packed__)) _WL_Struct
    {
        PdsWlHeader_t pdsWlHeader;
        PdsWlData_t pdsWlData[PDS_WL_DATA_SIZE];
    } WL_Struct;
    struct __attribute__((__packed__)) _WL_Mem
    {
...
{
    struct __attribute__((__packed__)) _NVM_Struct
    {
        PdsNvmHeader_t pdsNvmHeader;
        PdsNvmData_t pdsNvmData;
    } NVM_Struct;
    struct __attribute__((__packed__)) _NVM_Mem
    {
