...
#if (ENABLE_PDS == 1)
typedef struct __attribute__((__packed__)) _RegPdsItems
{
    uint8_t  fileid;
    uint16_t lastUsedSB;
...
typedef struct __attribute__((__packed__)) _DutyCycleTimer
{
...
typedef struct __attribute__((__packed__)) _JoinDutyCycleTimer
{
    /* Duty cycle timers last value */
...
typedef struct __attribute__((__packed__)) _JoinBackoffTimer
{
    /* The unique Id given to the timer */
    uint8_t timerId;
}    JoinBackoffTimer_t;
...
typedef struct __attribute__((__packed__)) _LBTTimer
{
    uint32_t lastTimerValue;
    uint8_t timerId;
}    LBTTimer_t;
...
typedef struct __attribute__((__packed__)) _SubBandParams
{
...
typedef struct __attribute__((__packed__)) _channelParams
{
...
typedef struct __attribute__((__packed__)) _OthChannelParams
{
...
typedef struct __attribute__((__packed__)) _DRParams
{
...
typedef struct __attribute__((__packed__)) _RegParamsType1
{
...
typedef struct __attribute__((__packed__)) _RegParamsType2
{
...
typedef union __attribute__((__packed__)) _CmnParams
{
...
typedef struct __attribute__((__packed__)) _RegParams
{
